@php
    $map = [
        ...
        'data_kurang' => 'bg-orange-100 text-orange-700 ring-orange-200',
        'survey' => 'bg-violet-100 text-violet-700 ring-violet-200',
        'direkomendasikan' => 'bg-emerald-100 text-emerald-700 ring-emerald-200',
        'tidak_direkomendasikan' => 'bg-rose-100 text-rose-700 ring-rose-200',
        'diterima' => 'bg-emerald-100 text-emerald-700 ring-emerald-200',
        'ditolak' => 'bg-rose-100 text-rose-700 ring-rose-200',
        'dibatalkan_user' => 'bg-zinc-100 text-zinc-700 ring-zinc-200',
